...
namespace AZ::RHI
{
    ...
    //! SingleDeviceResourceView is a base class for views which are dependent on a SingleDeviceResource instance.
    //!
    ...
    public:
        ...
        virtual ~SingleDeviceResourceView() = default;
        ...
        AZ_RTTI(SingleDeviceResourceView, "{7F50934E-A2F3-4989-BB8C-F3AFE33BEBDD}", Object);
